        ...
        getDictionaries() {
            this.$http.get("dictionaries/" + service.id).then(response => {
                if (response.body != null) {
                    ...
                    this.$http
                        .get("lists/" + this.activeDictionary.id)
                        .then(response => {
                            if (response.body != null) {
